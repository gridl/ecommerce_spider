...
from ecommerce.items import EcommerceItem, RelatedProduct, Price,\
    BuyerReviews
try:
    from ecommerce.settings import ZERO_REVIEWS_VALUE
except:
    ZERO_REVIEWS_VALUE = 0
from ecommerce.spiders import BaseProductsSpider
from ecommerce.spiders import cond_set, cond_set_value
